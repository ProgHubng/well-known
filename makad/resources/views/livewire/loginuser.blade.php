...
focus:ring-0 ring-0 font-medium focus:outline-none focus:outline-none" id="phone_no" inputmode="tel" name="phone_no"
                        placeholder="Enter your mobile number" required type="text" wire:model="phone_number">
