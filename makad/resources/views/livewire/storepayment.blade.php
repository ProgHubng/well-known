<form method="post" action="{{ url('/storepayment') }}"
    ...
    <div class="relative">
        <button class="h-12 rounded-full text-white flex w-full tracking-normal bg-gradient-100 items-center justify-center box-content py-1
            focus:ring-4 focus:outline-none outline-none focus:ring-opacity-50 mx-auto font-semibold btn"
