const countDown = el => {
    ...
    // print(el.dataset)
    // let diff, now, date
    // date = new Date(el.dataset.timestamp)
    // now = new Date()
    // diff = date - now
    // diff = diff / 1000
    // console.log(diff)
...
const count = diff => {
    let weeks, rem, days, hours, secs, mins
...
const uploadFile =  e => {
    e.preventDefault()
    const URL = 'https://api.cloudinary.com/v1_1/dq8nv0pj6/upload'
    const UPLOAD_PRESET = 'tsyyldp2'
