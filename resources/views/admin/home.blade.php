            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="icon-card mb-30">
                        ...
                        <div class="content">
                            <h6 class="mb-10">Total Plans</h6>
                            <h3 class="text-bold mb-10">{{ $plans }}</h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="icon-card mb-30">
                        ...
                        <div class="content">
                            <h6 class="mb-10">Total Deposit</h6>
                            <h3 class="text-bold mb-10">N{{ $total_dep }}</h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="icon-card mb-30">
                        ...
                        <div class="content">
                            ...
                            <h3 class="text-bold mb-10">N{{ $total_with }}</h3>
